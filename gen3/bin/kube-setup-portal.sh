...
gen3 roll portal $([ ! -z "$dataUploadBucketName" ] && echo "GEN3_DATA_UPLOAD_BUCKET $dataUploadBucketName " || echo "") $([ ! -z "$gearbox_s3_bucket" ] && echo "GEN3_GEARBOX_S3_BUCKET $gearbox_s3_bucket " || echo "")
