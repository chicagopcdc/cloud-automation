...
gen3 roll portal $([ -z ${dataUploadBucketName+x} ] && echo "GEN3_DATA_UPLOAD_BUCKET $dataUploadBucketName " || echo "") $([ -z ${gearbox_s3_bucket+x} ] && echo "GEN3_GEARBOX_S3_BUCKET $gearbox_s3_bucket " || echo "")
